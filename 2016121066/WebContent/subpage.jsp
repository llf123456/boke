...
<title>Paint Blog - free website template</title>
<meta name="keywords" content="paint blog, free css template, website layout, CSS, HTML" />
<meta name="description" content="Paint Blog Layout - free website template provided from cssMoban.com" />
<link href="templatemo_style.css" rel="stylesheet" type="text/css" />
<!--  Free CSS Template is designed from cssMoban.com  -->
<!--[if lt IE 7]>
<style type="text/css">
...
<div id="templatemo_menu_panel">
    <div id="templatemo_menu_section">
        <ul>
            ...
            <li><a href="subpage.jsp" class="current">Features</a></li>
            <li><a href="subpage.jsp">Gallery</a></li>
            ...
            <div class="templatemo_content_left_section">
                ...
                <div class="left_section_content">
           	    <ul class="gallery">
                        ...
                        <li><a href="http://www.cssmoban.com" target="_blank"><img src="images/templatemo_thumb_04.jpg" alt="Free Template" /></a></li>
                        <li><a href="#" target="_blank"><img src="images/templatemo_thumb_05.jpg" alt="Flash Resources" /></a></li>
         ...
         <div id="templatemo_content_right">
        	<div class="templatemo_post_section">
            	...
            	<div class="post_content">                	
                  ...
                  <div class="post_info">
                        	Posted by <a href="http://www.cssmoban.com" target="_parent">网页模板</a>, in <a href="#">Web Template.</a> | <a href="#"><span class="comment">12 comments.</span></a>
                        </div>
                    </div>
                    
                    <div class="post_body">
                        <img src="images/templatemo_image_01.jpg" alt="image" />
                        <p>This blog layout is a <a href="http://www.cssmoban.com" target="_parent">free CSS template</a> provided from cssMoban.com website. You may download, modify and apply this CSS layout for your personal or business websites.</p>
                         <p>Credit goes to <a href="#" target="_blank">photovaco.com</a> for photos. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus nec dui. Donec nec neque ut quam sodales feugiat. Nam vehicula dapibus lectus. Integer imperdiet pretium dolor. </p>
                         <p>Vivamus felis. Vivamus vulputate vehicula mi. Maecenas consectetur purus. Aliquam tristique lacus in sapien. Suspendisse potenti. Ut sed pede. Nullam vitae tellus. Sed ultrices. Lorem ipsum dolor sit amet, consectetuer adipiscing elit</p>
                  </div>  
            ...
            <div class="comment_section">
            	...
            	<div class="comment_box">
                    <div class="comment_title">1. Phasellus ultrices justo</div>
                ...
                <div class="comment_box">
                    <div class="comment_title">2. Vivamus vestibulum</div>
                  <div class="comment_body">
    ...
    <div id="templatemo_bottom_section">
    	...
    	<div id="templatemo_bottom_section_left">
        	...
        	<ul class="popular_post">	
                <li><a href="#">Donec mollis aliquet</a><br />Author name - Oct 26, 2024  <span class="comment">12</span></li>
                <li><a href="#">Aliquam tristique lacust</a><br />Author name - Oct 24, 2024  <span class="comment">8</span></li>
                <li><a href="#">Suspendisse potent</a><br />Author name - Oct 19, 2024  <span class="comment">10</span></li>
                <li><a href="#">Nullam vitae tellus</a><br />Author name - Oct 14, 2024  <span class="comment">30</span></li>
                <li><a href="#">Lorem ipsum dolor</a><br />Author name - Oct 12, 2024  <span class="comment">15</span></li>
            </ul>
        </div>   
...
<div id="templatemo_footer_panel">
    <div id="templatemo_footer_section">
        Copyright © 2024 <a href="#">Your Company Name</a> | from <a href="http://www.cssmoban.com" target="_parent">Free CSS Template</a>
    </div>
</div>
</body>
<!--  Free CSS Template is designed from cssMoban.com  -->
